package com.rockchipme.app.numpick;
...
public class ClickNumberPickerView extends PercentRelativeLayout {
    ...
    private void readAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.rockchipme.app.R.styleable.ClickNumberPicker);

        swipeEnabled = typedArray.getBoolean(com.rockchipme.app.R.styleable.ClickNumberPicker_swipe_enabled, true);
        value = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_value, CLICK_NUMBER_PICKER_VALUE_DEFAULT);
        minValue = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_min_value, CLICK_NUMBER_PICKER_MIN_VALUE_DEFAULT);
        maxValue = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_max_value, CLICK_NUMBER_PICKER_MAX_VALUE_DEFAULT);
        step = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_step, CLICK_NUMBER_PICKER_STEP_DEFAULT);
        integerPriority = typedArray.getBoolean(com.rockchipme.app.R.styleable.ClickNumberPicker_integer_priority, false);
        valueBackgroundColor = typedArray.getColor(com.rockchipme.app.R.styleable.ClickNumberPicker_value_background_color, 0);
        pickersBackgroundColor = typedArray.getColor(com.rockchipme.app.R.styleable.ClickNumberPicker_pickers_background_color, 0);
        animationUpEnabled = typedArray.getBoolean(com.rockchipme.app.R.styleable.ClickNumberPicker_value_animation_up, false);
        animationDownEnabled = typedArray.getBoolean(com.rockchipme.app.R.styleable.ClickNumberPicker_value_animation_down, false);
        valueColor = typedArray.getColor(com.rockchipme.app.R.styleable.ClickNumberPicker_value_text_color, 0);
        valueTextSize = typedArray.getDimensionPixelSize(com.rockchipme.app.R.styleable.ClickNumberPicker_value_text_size, CLICK_NUMBER_PICKER_VALUE_TEXT_SIZE_DEFAULT);
        valueMinTextSize = typedArray.getDimensionPixelSize(com.rockchipme.app.R.styleable.ClickNumberPicker_value_min_text_size, CLICK_NUMBER_PICKER_VALUE_ANIMATION_MIN_TEXT_SIZE_DEFAULT);
        valueMaxTextSize = typedArray.getDimensionPixelSize(com.rockchipme.app.R.styleable.ClickNumberPicker_value_max_text_size, CLICK_NUMBER_PICKER_VALUE_ANIMATION_MAX_TEXT_SIZE_DEFAULT);
        valueViewOffset = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_value_view_offset, CLICK_NUMBER_PICKER_VALUE_VIEW_OFFSET_DEFAULT);
        animationSwipeEnabled = typedArray.getBoolean(com.rockchipme.app.R.styleable.ClickNumberPicker_swipe_animation, false);
        pickerCornerRadius = typedArray.getFloat(com.rockchipme.app.R.styleable.ClickNumberPicker_picker_corner_radius, CLICK_NUMBER_PICKER_CORNER_RADIUS_DEFAULT);
        pickerBorderStrokeWidth = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_picker_border_stroke_width, 0);
        pickerBorderStrokeColor = typedArray.getColor(com.rockchipme.app.R.styleable.ClickNumberPicker_picker_border_stroke_color, 0);
        decimalNumbers = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_decimal_number, CLICK_NUMBER_PICKER_DECIMAL_NUMBER_DEFAULT);
        animationUpDuration = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_animation_value_up_duration, CLICK_NUMBER_PICKER_UP_DOWN_DURATION_DEFAULT);
        animationDownDuration = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_animation_value_down_duration, CLICK_NUMBER_PICKER_UP_DOWN_DURATION_DEFAULT);
        animationOffsetRightDuration = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_animation_offset_right_duration, CLICK_NUMBER_PICKER_OFFSET_ANIMATION_DURATION_DEFAULT);
        animationOffsetLeftDuration = typedArray.getInt(com.rockchipme.app.R.styleable.ClickNumberPicker_animation_offset_left_duration, CLICK_NUMBER_PICKER_OFFSET_ANIMATION_DURATION_DEFAULT);
        leftPickerLayout = typedArray.getResourceId(com.rockchipme.app.R.styleable.ClickNumberPicker_left_picker_layout, com.rockchipme.app.R.layout.left_picker_view_default);
        rightPickerLayout = typedArray.getResourceId(com.rockchipme.app.R.styleable.ClickNumberPicker_right_picker_layout, com.rockchipme.app.R.layout.right_picker_view_default);
        typedArray.recycle();
    }
    ...
    private void initViews() {
        View view = inflate(getContext(), com.rockchipme.app.R.layout.view_click_numberpicker, this);

        flLeftPicker = (FrameLayout) view.findViewById(com.rockchipme.app.R.id.fl_click_numberpicker_left);
        rlRootView = (PercentRelativeLayout) view.findViewById(com.rockchipme.app.R.id.rl_pickers_root);
        flRightPicker = (FrameLayout) view.findViewById(com.rockchipme.app.R.id.fl_click_numberpicker_right);
        rlCenter = (RelativeLayout) view.findViewById(com.rockchipme.app.R.id.center_picker);
        tvValue = (TextView) view.findViewById(com.rockchipme.app.R.id.tv_value_numberpicker);
